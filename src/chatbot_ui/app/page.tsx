    ...
    if (promptInput && promptInput.current) {
      ...
      if (prompt !== "") {
        ...
        const res = await fetch("http://localhost:8080", {
          method: "POST",
          body: JSON.stringify({ history: state.messages, prompt }),
          headers: {
        ...
        <div className="absolute bottom-6  w-full px-1">
          ...
          <div className="relative flex flex-col w-full p-3  bg-gray-800 rounded-md shadow ring-1 ring-gray-200 dark:ring-gray-600 focus-within:ring-2 focus-within:ring-inset dark:focus-within:ring-indigo-600 focus-within:ring-indigo-600">
            ...
            <TextareaAutosize
              ...
              className="m-0 w-full resize-none border-0 bg-transparent  pr-7 focus:ring-0 focus-visible:ring-0 dark:bg-transparent text-gray-800 dark:text-gray-50 text-base text-white"
              placeholder="Any questions about allotrack database that I can help you with ?"
              defaultValue=""
            />
